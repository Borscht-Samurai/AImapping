...
<main class="site-main">
    <div class="container">
        <div class="post-form-container">
            <h1 class="form-title">イベントの編集</h1>
                ...
                if (!isset($_POST['event_nonce_field']) || !wp_verify_nonce($_POST['event_nonce_field'], 'event_nonce_action')) {
                    ...
                    if (empty($errors)) {
                        ...
                        if ($updated) {
                            ...
                            // カテゴリーの更新
                            if (!empty($_POST['event_category'])) {
                                wp_set_object_terms($post_id, intval($_POST['event_category']), 'event_category');
                            }
                            ...
                            echo '<div class="form-message success">イベントが更新されました。 <a href="' . get_permalink($post_id) . '">イベントページを表示</a></div>';
                        } else {
                            echo '<div class="form-message error">イベントの更新に失敗しました。</div>';
                        }
                    } else {
                        // エラーメッセージの表示
            ...
            <form class="post-form" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <label for="event_title">イベントタイトル <span class="required">*</span></label>
                    <input type="text" id="event_title" name="event_title" class="form-control" value="<?php echo esc_attr($event_title); ?>" required>
                </div>
                
                <div class="form-group">
                    <label for="event_content">イベント内容 <span class="required">*</span></label>
                    ...
                    <p class="form-hint">イベントの詳細、参加条件、持ち物などを記載してください。</p>
                </div>
